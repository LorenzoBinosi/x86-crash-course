...
void foo() {
  ...
  \begin{column}{0.4\linewidth}
    ...
    \cell{}
    \cell{}
    \bcell{Return addr (s{\tt EIP})}\cellptr{{\tt ESP}} 
    \stackbottom
    \end{tikzpicture}
    {\scriptsize High addresses ({\tt 0xbfffffff})}
  \end{column}
...
FOO:
    ...
    \begin{column}{0.4\linewidth}
      ...
      \cell{}
      \cell{}
      \bcell{Return addr (s{\tt EIP})}\cellptr{{\tt ESP, EBP}} 
      \stackbottom
      \end{tikzpicture}
      {\scriptsize High addresses ({\tt 0xbfffffff})}
    \end{column}
...
FOO:
    ...
    \begin{column}{0.4\linewidth}
      ...
      \cell{}
      \cell{}
      \bcell{(a)}\cellptr{{\tt ESP}} 
      \bcell{(b)}
      \bcell{(c)}
      \bcell{Return addr (s{\tt EIP})}\cellptr{{\tt EBP}} 
      \stackbottom
      \end{tikzpicture}
      {\scriptsize High addresses ({\tt 0xbfffffff})}
    \end{column}
...
FOO:
    ...
    \begin{column}{0.4\linewidth}
      ...
      \cell{0}
      \cell{}
      \cell{Return addr (s{\tt EIP})}\cellptr{{\tt EBP}} 
      \stackbottom\cellptr{{\tt ESP}} 
      \end{tikzpicture}
      {\scriptsize High addresses ({\tt 0xbfffffff})}
    \end{column}
  \end{columns}
...
BAR:
    ...
    \begin{column}{0.4\linewidth}
      ...
      \cell{}
      \cell{}
      \bcell{foo ret addr (s{\tt EIP})}\cellptr{{\tt ESP}}
      \bcell{(a)}
      \bcell{(b)}
      \bcell{(c)}
      \bcell{Return addr (s{\tt EIP})}\cellptr{{\tt EBP}} 
...
BAR:
    ...
    \begin{column}{0.4\linewidth}
      ...
      \cell{}
      \cell{}
      \bcell{foo ret addr (s{\tt EIP})}\cellptr{{\tt ESP, EBP}}
      \bcell{(a)}
      \bcell{(b)}
      \bcell{(c)}
...
BAR:
    ...
    \begin{column}{0.4\linewidth}
      ...
      \startframe
      \cell{}
      \bcell{(d)}\cellptr{{\tt ESP}}
      \bcell{foo ret addr (s{\tt EIP})}\cellptr{{\tt EBP}}
      \bcell{(a)}
      \bcell{(b)}
      \bcell{(c)}
      \bcell{Return addr (s{\tt EIP})} 
...
BAR:
    ...
    \begin{column}{0.4\linewidth}
      ...
      \cell{}
      \cell{1}
      \cell{foo ret addr (s{\tt EIP})}\cellptr{{\tt EBP}}
      \bcell{(a)}\cellptr{{\tt ESP}}
      \bcell{(b)}
      \bcell{(c)}
      \bcell{Return addr (s{\tt EIP})} 
...
\begin{column}{0.4\linewidth}
	...
	\stacktop{}
	\startframe
	\bcell{Local variables}\cellptr{{\tt ESP}} 
	\bcell{Saved {\tt EBP}}\cellptr{{\tt EBP}} \coordinate (p1) at (currentcell.east);
